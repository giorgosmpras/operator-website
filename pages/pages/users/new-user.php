            ...
            <ul class="navbar-nav">
                ...
                <li class="nav-item">
                    ...
                    <div class="collapse show " id="pagesExamples">
                        <ul class="nav ">
                            <li class="nav-item ">
                                <a class="nav-link bg-dark text-white " href="./new-user.php">
                                    <span class="material-symbols-outlined   ps-3">
                                        person_add
                                    </span>
                                    <span class="sidenav-normal text-white  ms-2  ps-1"> Εγγραφή </span>
                                </a>
                            </li>
                            <li class="nav-item ">
            ...
            <div class="container-fluid py-1 px-3">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
                        ...
                        <li class="breadcrumb-item text-sm text-dark" aria-current="page">Εγγραφή Δημότη</li>
                    </ol>
                    <h6 class="font-weight-bolder mb-0">Εγγραφή Δημότη</h6>
                </nav>
                ...
                <div class="collapse navbar-collapse mt-sm-0 mt-2 me-md-0 me-sm-4" id="navbar">
                    <div class="ms-md-auto pe-md-3 d-flex align-items-center">
                        ...
                        <ul class="navbar-nav  justify-content-end">
                            <li class="nav-item">
                                <a href="./new-user.php" class="nav-link text-body p-0 position-relative"
                                    target="_blank">
                                    ...
                                    <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
                                        <div class="bg-dark shadow-dark border-radius-lg pt-4 pb-3">
                                            <div class="multisteps-form__progress">
                                                ...
                                                <button id="address" class="multisteps-form__progress-btn" type="button"
                        ...
                        <button class="multisteps-form__progress-btn" type="button" title="Profile">Profile</button>-->
                                    ...
                                    <div class="card-body">
                                        ...
                                        <form role="form" class="multisteps-form__form" method="post"
                                            action="new-user-function.php">
                                            <!--single form panel-->
                                            <div class="multisteps-form__panel border-radius-xl bg-white js-active"
                                                data-animation="FadeIn">
                                                <h5 class="font-weight-bolder mb-0">Προσωπικα Στοιχεια</h5>
                                                    ...
                                                    <div class="row mt-3">
                                                        <div class="col-12 col-sm-6">
                                                            ...
                                                            <div class="input-group input-group-dynamic">
                                                                <label class="form-label" id="nameLabel">Ονομα*</label>
                                                        ...
                                                        <div class="col-12 col-sm-6 mt-3 mt-sm-0">
                                                            <div class="input-group input-group-dynamic">
                                                                ...
                                                                <label class="form-label"
                                                                    id="lastnameLabel">Επίθετο*</label>
                              ...
                              >-->
                                                    ...
                                                    <div class="button-row d-flex mt-4">
                                                        ...
                                                        <!--<button class="btn bg-gradient-dark ms-auto mb-0 js-btn-next" type="button" title="Next">Επομενο</button>-->
                                                    </div>
                                                </div>
                                            </div>
                                            <!--single form panel-->
                                            <div class="multisteps-form__panel border-radius-xl bg-white"
                                                data-animation="FadeIn">
                                                <h5 class="font-weight-bold mb-0">Διευθυνση Κατοικιας</h5>
