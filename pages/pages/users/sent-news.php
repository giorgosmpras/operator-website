          ...
          <h6 class="ps-4  ms-2 text-uppercase text-xs font-weight-bolder text-dark">Σελιδες</h6>
                ...
                <li class="nav-item">
                    ...
                    <div class="collapse show" id="authExamples1">
                        <ul class="nav ">
                            <li class="nav-item ">
                                <a class="nav-link bg-dark  text-white " href="./sent-news.php">
                                    <span class="material-symbols-outlined ps-3">
                                        send
                                    </span>
        ...
        <nav class="navbar navbar-main navbar-expand-lg position-sticky mt-4 top-1 px-0 mx-4 shadow-none border-radius-xl z-index-sticky"
            ...
            <div class="container-fluid py-1 px-3">
                <nav aria-label="breadcrumb">
                    ...
                    <h6 class="font-weight-bolder mb-0">Νέα Ανακοίνωση</h6>
                </nav>
                                ...
                                <div class="card ">
                                    ...
                                    <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
                                        <div class="bg-dark shadow-dark border-radius-lg pt-4 pb-3">
                                            ...
                                            <div class="text">
                                                ...
                                                <span>Αποστολή Ανακοίνωσης</span>
                                    ...
                                    <div class="card">
                                        <div class="card-body">
                                            ...
                                            <button class="btn bg-gradient-dark ms-auto mb-0 js-btn-next" id="send-btn"
                                                disabled>Αποστολη</button>
                                        </div>
                                    </div>
                                    ...
                                    togglePushBtn.addEventListener('click', togglePushNotifications);
                                    ...
                                    async function submitForm() {
                                        ...
                                        try {
                                            ...
                                            const response = await fetch(
                                                'https://api.valmore.gr/api/organization-send-announc?title=' +
                                                title + "&body=" + description + "&created_by=" + created_by, {
                                                    method: 'POST',
                                                    headers: {
                                                        'Content-Type': 'application/json'
                                                    },
