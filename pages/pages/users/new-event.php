            ...
            <ul class="navbar-nav">
                ...
                <li class="nav-item">
                    ...
                    <div class="collapse show" id="authExamples3">
                        <ul class="nav ">
                            <li class="nav-item ">
                                <a class="nav-link bg-dark text-white " href="./new-event.php">
                                    <span class="material-symbols-outlined ps-3">
                                        send
                                    </span>
        ...
        <nav class="navbar navbar-main navbar-expand-lg position-sticky mt-4 top-1 px-0 mx-4 shadow-none border-radius-xl z-index-sticky"
            ...
            <div class="container-fluid py-1 px-3">
                <nav aria-label="breadcrumb">
                    ...
                    <h6 class="font-weight-bolder mb-0">Νέα Εκδήλωση</h6>
                </nav>
                                ...
                                <div class="card">
                                    <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
                                        <div class="bg-dark shadow-dark border-radius-lg pt-4 pb-3">
                                            <div class="text">
                                                ...
                                                <span>Δημιουργία Νέας Εκδήλωσης</span>
                                        ...
                                        <div class="card-body">
                                            ...
                                            <div class="input-field">
                                                ...
                                                <textarea class="multisteps-form__input" id="description"
                                                    maxlength="100" required style="height: 140px;"></textarea>
                                            ...
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="image-upload-center ">
                                                        <label class="custom-file-input-label mb-0  bg-dark text-white"
                                                            id="selectImageButton">
                                                            Επιλέξτε Εικόνα
                                                            <input id="image" type="file" class="file-input-element"
                                                                accept="image/*">
                                                        </label>
                                                    </div>
                                                    <script>
                                            ...
                                            <div class="button-row d-flex mt-4">
                                                <button id="submitButton"
                                                    ...
                                                    type="button" title="Next">ΑΠΟΣΤΟΛΗ</button>
                                            </div>
                                        </div>
                                    </div>

                                    <script>
                                    const inputFields = document.querySelectorAll(".multisteps-form__input");
                                            ...
                                            try {
                                                ...
                                                if (isToggleButtonActive) {
                                                    const response1 = await fetch(
                                                        'https://api.valmore.gr/api/push-notification-news', {
                                                            method: 'POST',
                                                            headers: {
                                                ...
                                                const response = await fetch(
                                                    'https://api.valmore.gr/api/organization/new-event', {
                                                        method: 'POST',
                                                        headers: {
                                                            'Content-Type': 'application/json'
                                                        },
                                                ...
                                                if (response.ok) {
                                                    ...
                                                    if (imageInput.files.length > 0) {
                                                        await uploadImage(savedResponse);
                                                    }
                                                } else {
                                    ...
                                    async function uploadImage(eventId) {
                                        try {
                                            ...
                                            const response = await fetch(
                                                `https://api.valmore.gr/api/event/upload-event-photo?id=${eventId}`, {
                                                    method: 'POST',
                                                    body: formData
                                                });
