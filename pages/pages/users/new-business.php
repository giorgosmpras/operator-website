          ...
          <h6 class="ps-4  ms-2 text-uppercase text-xs font-weight-bolder text-dark">Σελιδες</h6>
                ...
                <li class="nav-item">
                    ...
                    <div class="collapse  show" id="ecommerceExamples">
                        <ul class="nav ">
                            <li class="nav-item ">
                                <a class="nav-link bg-dark text-white " href="./new-business.php">
                                    <span class="material-symbols-outlined ps-3">
                                        add_business
                                    </span>
            ...
            <div class="container-fluid py-1 px-3">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
                        ...
                        <li class="breadcrumb-item text-sm text-dark" aria-current="page">Εγγραφή Επιχείρησης</li>
                    </ol>
                    <h6 class="font-weight-bolder mb-3">Εγγραφή Επιχείρησης</h6>
                </nav>
                    ...
                    <div class="multisteps-form mb-5">
                        <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
                            <h6 class="font-weight-bolder  text-align:center text-red mt-1">
                                <?php if(isset($_GET['success'])){echo '<span style="color:green;text-align:center;margin-left: 20px">Η εγγραφη ολοκληρωθηκε επιτυχως</span>';}elseif(isset($_GET['error'])){echo '<span style="color:red;text-align:center;margin-left: 20px">Κάτι πήγε λάθος, Προσπαθήστε ξανά</span>';}?>
                            </h6>
                        </div>
                        <!--progress bar-->
                        <div class="row">
