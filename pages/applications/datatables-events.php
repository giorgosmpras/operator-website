...
<body class="g-sidenav-show  bg-gray-200">
                ...
                <li class="nav-item">
                    ...
                    <div class="collapse show" id="authExamples3">
                        <ul class="nav ">
                            ...
                            <li class="nav-item ">
                                <a class="nav-link bg-dark  text-white " href="../applications/datatables-events.php">
                                    <span class="material-symbols-outlined ps-3">
                                        table_chart
                                    </span>
                                    <span class="sidenav-normal  ms-2  ps-1"> Προβολή </span>
    ...
    <main class="main-content position-relative max-height-vh-100 h-100 border-radius-lg ">
        ...
        <nav class="navbar navbar-main navbar-expand-lg position-sticky mt-4 top-1 px-0 mx-4 shadow-none border-radius-xl z-index-sticky"
            ...
            <div class="container-fluid py-1 px-3">
                <nav aria-label="breadcrumb">
                    ...
                    <h6 class="font-weight-bolder mb-0">Προβολή Εκδηλώσεων</h6>
                </nav>
                        ...
                        <div class="card-header">
                            <div class="row align-items-center">
                                <div class="col-md-6" style="margin-bottom:2%;">
                                    <h5 class="mb-0">Αναζήτηση Εκδηλώσεων</h5>
                                    <p class="text-sm mb-0">
                                        Αναζητήστε και Παραμετροποιήστε την εκδήλωση που επιθυμείτε
                                    </p>
                                </div>


                                <div class="col-md-6">
                                    <button onClick="window.location.href='../pages/users/new-event.php';"
                                        class="btn btn-dark" style="float: right; width: 200px;">
                                        Νεα Εκδηλωση <i class="fas fa-paper-plane btn-icon"
                                    ...
                                    <div class="modal-dialog" role="document">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                <h5 class="modal-title" id="deleteModalLabel">Διαγραφή Εκδήλωσης</h5>
        ...
        async function fetchData() {
            try {
                const response = await fetch('https://api.valmore.gr/api/organization/events-list');
        ...
        function displayNoResultsRow() {
            ...
            if (!document.getElementById('noResultsRow')) {
                ...
                messageCell.textContent = 'Δεν Βρέθηκαν διαθέσιμες Εκδηλώσεις Πατήστε εδώ για να προσθέσετε';
                ...
                messageCell.addEventListener('click', () => {
                    ...
                    window.location.href = `../pages/users/new-event.php`;
                });
