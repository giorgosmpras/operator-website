...
<body class="g-sidenav-show  bg-gray-200">
                ...
                <li class="nav-item">
                    ...
                    <div class="collapse show" id="authExamples2">
                        <ul class="nav ">
                            ...
                            <li class="nav-item ">
                                <a class="nav-link bg-dark  text-white " href="../applications/datatables-messages.php">
                                    <span class="material-symbols-outlined ps-3 ">
                                        <span class="material-symbols-outlined ">
                                            table_chart
                                        </span>
    ...
    <main class="main-content position-relative max-height-vh-100 h-100 border-radius-lg ">
        ...
        <nav class="navbar navbar-main navbar-expand-lg position-sticky mt-4 top-1 px-0 mx-4 shadow-none border-radius-xl z-index-sticky"
            ...
            <div class="container-fluid py-1 px-3">
                <nav aria-label="breadcrumb">
                    ...
                    <h6 class="font-weight-bolder mb-0">Προβολή Μηνυμάτων</h6>
                </nav>
                        ...
                        <div class="card-header">
                            <div class="row align-items-center">
                                <div class="col-md-6" style="margin-bottom:2%;">
                                    <h5 class="mb-0">Αναζήτηση Μηνυμάτων</h5>
                                    <p class="text-sm mb-0">
                                        Αναζητήστε το μήνυμα που επιθυμείτε
                                    </p>
                                </div>


                                <div class="col-md-6">
                                    <button onClick="window.location.href='../pages/users/sent-message.php';"
                                        class="btn btn-dark" style="float: right; width: 200px;">
                                        Νέο Μήνυμα <i class="fas fa-paper-plane btn-icon" style="margin-left: 2px"></i>
                                    </button>
                                </div>
                                    ...
                                    <tr>
                                        <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7"
                                            ...
                                            <span class="sort-icon" id="name-sort">
                                                <i class="fas fa-sort" data-order="asc"
                                                    style="float: right; margin-right: 30px"></i>
                                            </span>
                                        </th>
                                        <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7"
                                            style="text-align: start;">
            ...
            if (data.lenght == 0) {
                ...
                for (let i = startIndex; i < endIndex && i < data.length; i++) {
                    ...
                    properties.forEach((prop) => {
                        ...
                        cell.classList.add('text-sm', 'font-weight-normal', 'width');
                        cell.style.width = "15% "
        ...
        async function fetchData() {
            try {
                const response = await fetch('https://api.valmore.gr/api/fetch-push-notification');
        ...
        function displayNoResultsRow() {
            ...
            if (!document.getElementById('noResultsRow')) {
                ...
                messageCell.textContent = 'Δεν Βρέθηκαν διαθέσιμα Μηνύματα Πατήστε εδώ για να προσθέσετε';
                ...
                messageCell.addEventListener('click', () => {
                    ...
                    window.location.href = `../pages/users/sent-message.php`;
                });
