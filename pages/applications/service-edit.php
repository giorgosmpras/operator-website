...
<head>
    ...
    /*top: 20px; /* Adjust this value for the desired vertical position */
        /*left: 50%; /* Position the container horizontally at 50% of its containing element */
            ...
            <ul class="navbar-nav">
                ...
                <li class="nav-item">
                    <a data-bs-toggle="collapse" href="#applicationsExamples" class="nav-link text-dark active"
                        ...
                        <span class="nav-link-text font-weight-bold ms-2 ps-1 text-dark">Υπηρεσίες</span>
                    </a>
    ...
    <main class="main-content position-relative max-height-vh-100 h-100 border-radius-lg ">
        ...
        <nav class="navbar navbar-main navbar-expand-lg position-sticky mt-4 top-1 px-0 mx-4 shadow-none border-radius-xl z-index-sticky"
            ...
            <div class="container-fluid py-1 px-3">
                <nav aria-label="breadcrumb">
                    ...
                    <h6 class="font-weight-bolder mb-0">Επεξεργασία Υπηρεσίας</h6>
                </nav>
                ...
                <div class="col-12">
                                                        ...
                                                        <div class="row mt-3">
                                                            ...
                                                            <div class="col-12 col-sm-6 mt-3 mt-sm-0">
                                                                <div class="toggle-container">
                                                                    <div
                                                                        class="toggle-texts font-weight-bold text-dark position-relative">
                                                                        <div class="toggle-text1">
                                                                            <p>Με συνδρομή</p>
                                                                            <div class="toggle-button" id="button1">
                                                                            </div>
                                                                        </div>

                                                                        <div class="toggle-text3">
                                                                            <p>Ελεύθερη Είσοδος</p>
                                                                            <div class="toggle-button" id="button3">
                                                                            </div>
                                                                        </div>
                                                                    </div>

                                                                </div>
                                                                <input type="hidden" name="button1" id="hiddenButton1"
                                                                    value="<?php echo $subscriptionService; ?>">
                                                                <input type="hidden" name="button3" id="hiddenButton3"
                                                                    value="<?php echo $autoEntrance; ?>">
                                                                ...
                                                                buttons.forEach((button, index) => {
                                                                    const hiddenInput = document.getElementById(
                                                                        `hiddenButton${index + 1}`);

                                                                    // Set initial state based on PHP variables
                    ...
                    <td class="text-sm font-weight-normal">$112,000</td>
                                                            ...
                                                            async function populateTable() {
                                                                ...
                                                                if (data && data.service && Array.isArray(data
                                                                        .service
                                                                        .fullName) && data.service.fullName
                                                                    .length > 0) {
                                                                    const fullNames = data.service
                                                            ...
                                                            async function fetchData() {
                                                                try {
                                                                    const response = await fetch(
                                                                        `https://api.valmore.gr/api/organization/services-data?services_id=${<?php echo json_encode($id); ?>}`
                                                                    )
                                                    ...
                                                    <div class="multisteps-form__content">
                                                        <div class="row mt-3">
                                                            ...
                                                            async function uploadImage(itemId, formData) {
                                                                try {
                                                                    const response = await fetch(
                                                                        `https://api.valmore.gr/api/profile/service/upload?_id=${itemId}`, {
                                                                            method: 'POST',
                                                                            body: formData,
                                                                        });
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        Είστε Βέβαιοι οτι θέλετε να Διαγράψετε την Υπηρεσίας;<br>
            ...
            <div class="modal-dialog modal-dialog1" role="document">
                <div class="modal-content">
                    ...
                    async function newUserAdd(userId, businessId) {
                        ...
                        // Define the URL
                        const url = 'https://api.valmore.gr/api/organization/add-service-user';
        ...
        function showDeleteModal() {
            ...
            document.getElementById('confirmDelete').addEventListener('click', () => {
                ...
                window.location.href = `service-edit-patch.php?delete_id=${id}`;
        ...
        async function newUserRemove(userId, businessId) {
            ...
            // Define the URL
            const url = 'https://api.valmore.gr/api/organization/remove-service-user';
