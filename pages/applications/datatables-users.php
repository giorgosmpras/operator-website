...
<head>
    ...
    /* Style for normal (unchecked) checkbox */
    input[type="checkbox"] {
        width: 16px;
...
-->
                        ...
                        <ul class="nav ">
                            ...
                            <li class="nav-item ">
                                <a class="nav-link bg-dark text-white "
                                    href="../../../pages/applications/datatables-users.php">
                                    <span class="material-symbols-outlined   ps-3">
                                        groups
                                    </span>
    ...
    <main class="main-content position-relative max-height-vh-100 h-100 border-radius-lg ">
            ...
            <div class="container-fluid py-1 px-3">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
                        ...
                        <li class="breadcrumb-item text-sm text-dark" aria-current="page">Προβολή Δημοτών</li>
                    </ol>
                    <h6 class="font-weight-bolder mb-0">Προβολή Δημοτών</h6>
                </nav>
        ...
        <div class="container-fluid py-4">
            <div class="row mt-4">
                <div class="col-12">
                    <?php if(isset($_GET['edited'])){echo '<span style="color:green;text-align:center;margin-left: 20px;">Η Επεξεργασία ολοκληρωθηκε επιτυχως</span>';}elseif(isset($_GET['successActive'])){echo '<span style="color:green;text-align:center;margin-left: 20px;">Η ενεργοποίηση ολοκληρώθηκε επιτυχώς</span>';}elseif(isset($_GET['successDeactive'])){echo '<span style="color:green;text-align:center;margin-left: 20px;">Η απενεργοποίηση ολοκληρώθηκε επιτυχώς</span>';}elseif(isset($_GET['error'])){echo '<span style="color:red;text-align:center;margin-left: 20px;">Κάτι πήγε λάθος, Προσπαθήστε ξανά</span>';}?>
                        ...
                        <div class="card-header">
                            <div class="row align-items-center">
                                <div class="col-md-6" style="margin-bottom:2%;">
                                    <h5 class="mb-0">Αναζήτηση Δημότη</h5>
                                    <p class="text-sm mb-0">
                                        Αναζητήστε και Παραμετροποιήστε τον δημότη που επιθυμείτε
                                    </p>
                                </div>


                                <div class="col-md-6">
                                    <button onClick="window.location.href='../pages/users/new-user.php';"
                                        class="btn btn-dark" style="float: right; width: 200px;">
                                        Εγγραφη Δημότη <i class="fas fa-user-plus btn-icon"
                                ...
                                <div class="col-md-6">
                                    ...
                                    <!-- <label for="filterDropdown" style="margin-left: 0px; ">
                                        <select id="filterDropdown" class="dataTable-selector"
                                            style="background-color: white; border: 1px solid #E0E3E5; border-radius: .375rem; color: #7b809a; margin-top: 5px; margin-right: 10px">
                                            <option value="all">Δείξε όλους</option>
                                            <option value="active">Μόνο Ανενεργούς</option>
                                            <option value="deactivate">Μόνο Ενεργούς</option>
                                        </select>
                                        Φίλτρο
                                    </label> -->
                                </div>
                                    ...
                                    <tr>
                                        <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7"
                                            ...
                                            <span class="sort-icon" id="name-sort">
                                                <i class="fas fa-sort" style="float: right;" data-order="asc"></i>
                                            </span>
                                        </th>
                                        ...
                                        <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7"
                                            style="text-align: start;">
                                            Πατρωνυμο
                                            <span class="sort-icon" id="fname-sort">
                                                <i class="fas fa-sort" style="float: right;" data-order="asc"></i>
                                            </span>
                                        </th>
                                        <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7"
                                            style="text-align: start;">
                                            Μητρωνυμο
                                            <span class="sort-icon" id="mname-sort">
                                                <i class="fas fa-sort" style="float: right;" data-order="asc"></i>
                                            </span>
                                        </th>
                                        ...
                                        <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7"
                                            style="text-align: start;">
                                            Ημ/νια<br>Γεννησης
                                            <span class="sort-icon" id="birth-sort">
                                                <i class="fas fa-sort" style="float: right;" data-order="asc"></i>
                                            </span>
                                        </th>
        ...
        $(document).ready(function() {
            ...
            $("#fname-sort").click(function() {
                var newOrder = toggleSortOrder("fname-sort");
                performSort(newOrder, "td:eq(2)");
            });
            $("#mname-sort").click(function() {
                var newOrder = toggleSortOrder("mname-sort");
            ...
            $("#birth-sort").click(function() {
                var newOrder = toggleSortOrder("birth-sort");
                performSort(newOrder, "td:eq(5)");
            });
            $("#date-sort").click(function() {
                var newOrder = toggleSortOrder("date-sort");
                performSort(newOrder, "td:eq(6)");
            });
        });
        </script>
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="deleteModalLabel">Απενεργοποίηση Χρήστη</h5>
                    ...
                    <div class="modal-body">
                        Είστε Βέβαιοι οτι θέλετε να Απενεργοποιήσετε τον χρήστη
                    </div>
                    <div class="modal-footer">
                        <button type="button" class="btn btn-secondary" id="cancel"
                            data-dismiss="modal">Ακυρωση</button>
                        <button type="button" class="btn btn-danger" id="confirmDelete">Απενεργοποιηση</button>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="modal fade" id="activateModal" tabindex="-1" role="dialog" aria-labelledby="activateModalLabel"
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="activateModalLabel">Ενεργοποίηση Χρήστη</h5>
                    ...
                    <div class="modal-body">
                        Είστε Βέβαιοι οτι θέλετε να Ενεργοποιήσετε τον χρήστη
                    </div>
                    <div class="modal-footer">
                        <button type="button" class="btn btn-secondary" id="cancel2"
                            data-dismiss="modal">Ακυρωση</button>
                        <button type="button" class="btn btn-success" id="confirmActivate">Ενεργοποιηση</button>
                    </div>
                </div>
            </div>
        </div>
        ...
        async function populateTable(pageNumber) {
            ...
            if (data.length == 0) {
                ...
                for (let i = startIndex; i < endIndex && i < data.length; i++) {
                    ...
                    const properties = ['name', 'lastname', 'fathers_name', 'mothers_name', 'email',
                        'birth_date', 'mobile', 'dateOfRegistration'
                    ];
                    properties.forEach((prop) => {
                        const cell = document.createElement('td');
                        cell.classList.add('text-sm', 'text-left', 'font-weight-normal', 'width');
                    ...
                    if (item.active) {
                        ...
                        actionButton.innerHTML =
                            '<i class="material-symbols-outlined text-dark">check_circle</i>'; // Show Activate button for inactive users
                        actionButton.addEventListener('click', () => {
                            // Show the activate confirmation modal and pass the row ID
                            showActivateModal(item.Id);
                        });
                    }
                    // Create a cell for the button
                    // const buttonCell = document.createElement('td');
                    ...
                    if (!item.active) {
                        editButton.classList.add('hidden-button'); // Initially hide for false checkboxes
                    }
                    ...
                    editButton.addEventListener('click', () => {
                        ...
                        handleEditButtonClick(item.Id, item.name, item.lastname, item.fathers_name, item
                            .mothers_name, item.email, item.birth_date, item.mobile, item
                            .dateOfRegistration); // Pass the _id to the function
                    });
        ...
        // actionTitleCell.innerHTML = 'Ενεργ. /<br>Απενεργ.'; // Set the title text for "Action"
        ...
        function showDeleteModal(rowId) {
            ...
            document.getElementById('confirmDelete').addEventListener('click', () => {
                ...
                window.location.href = `user-edit-patch.php?delete_id=${rowId}`;
        ...
        function showActivateModal(rowId) {
            $('#activateModal').modal('show');

            document.getElementById('confirmActivate').addEventListener('click', () => {
                // Send a request to activate the user with the specified rowId
                window.location.href = `user-edit-patch.php?activate_id=${rowId}`;

                console.log('Activating user with ID:', rowId);
                // Close the modal
        ...
        async function fetchData() {
            try {
                const response = await fetch('https://api.valmore.gr/api/organization-fetch-users');
        ...
        function handleEditButtonClick(id, name, lastname, fathers_name, mothers_name, email, birth_date, mobile,
            dateOfRegistration) {
            ...
            const inputfathers_name = document.createElement('input');
            inputfathers_name.type = 'hidden'; // Hidden input
            inputfathers_name.name = 'fathers_name'; // Name of the input
            inputfathers_name.value = fathers_name; // Value is the _id

            const inputmothers_name = document.createElement('input');
            inputmothers_name.type = 'hidden'; // Hidden input
            inputmothers_name.name = 'mothers_name'; // Name of the input
            inputmothers_name.value = mothers_name; // Value is the _id
            ...
            inputbirth_date.name = 'birth_date'; // Name of the input
        ...
        function displayNoResultsRow() {
            ...
            if (!document.getElementById('noResultsRow')) {
                ...
                messageCell.colSpan =
                    9; // Replace with the actual number of columns in your table
                messageCell.classList.add('text-center', 'pressable-text', "messageCell");
                messageCell.textContent = 'Δεν Βρέθηκαν διαθέσιμοι δημότες Πατήστε εδώ για να προσθέσετε';
        ...
        function updateTable(filter) {
            ...
            tableRows.forEach((row) => {
                const isActive = row.querySelector('.action-button').innerHTML.includes('check_circle');

                if (filter === 'all' || (filter === 'active' && isActive) || (filter === 'deactivate' && !
                        isActive)) {
                    row.style.display = '';
                } else {
                    row.style.display = 'none';
                ...
                <div class="row align-items-center justify-content-lg-between">
                    ...
                    <div class="col-lg-6">
                        <ul class="nav nav-footer justify-content-center justify-content-lg-end">
                            <!--
                            <li class="nav-item">
                                <a href="https://www.valmore.gr" class="nav-link text-muted" target="_blank">About
                                    Us</a>
                            </li>
                            <li class="nav-item">
                                <a href="https://www.valmore.gr" class="nav-link text-muted" target="_blank">Blog</a>
                            </li>
                            <li class="nav-item">
                                <a href="https://www.valmore.gr" class="nav-link pe-0 text-muted"
