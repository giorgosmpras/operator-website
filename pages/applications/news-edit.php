            ...
            <ul class="navbar-nav">
                ...
                <li class="nav-item">
                    <a data-bs-toggle="collapse" href="#authExamples1" class="nav-link text-dark active"
                        ...
                        <span class="nav-link-text font-weight-bold ms-2 ps-1 text-dark">Ανακοινώσεις</span>
                    </a>
                        ...
                        <ul class="nav ">
                            ...
                            <li class="nav-item ">
                                <a class="nav-link bg-dark text-white "
                                    href="./../../../pages/applications/news-edit.php">
                                    <span class="material-symbols-outlined ps-3">
                                        edit
                                    </span>
        ...
        <nav class="navbar navbar-main navbar-expand-lg position-sticky mt-4 top-1 px-0 mx-4 shadow-none border-radius-xl z-index-sticky"
            ...
            <div class="container-fluid py-1 px-3">
                <nav aria-label="breadcrumb">
                    ...
                    <h6 class="font-weight-bolder mb-0">Επεξεργασία Ανακοίνωσης</h6>
                </nav>
                    ...
                    <div class="multisteps-form mb-5">
                        ...
                        <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2 ">
                            <h6 class="font-weight-bolder  text-align:center text-red mt-1">
                                <?php if(isset($_GET['success'])){echo '<span style="color:green;text-align:center;">Η επεξεργασία ολοκληρωθηκε επιτυχως</span>';}elseif(isset($_GET['success'])==""){echo "";}else{echo '<span style="color:red;text-align:center;">Σφαλμα</span>';}?>
                            </h6>
                        </div>
                        <!--progress bar-->
                        <div class="row">
                                    ...
                                    <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
                                        <div class="bg-dark shadow-dark border-radius-lg pt-4 pb-3">
                                            ...
                                            <div class="text">
                                                ...
                                                <span>Επεξεργασία Ανακοίνωσης</span>
                                        ...
                                        <div class="card">
                                            ...
                                            <div class="card-body">
                                                ...
                                                <div class="input-field">
                                                    ...
                                                    <input name="title" type="text" id="title" maxlength="20" required
                                                        value="<?php echo $title; ?>">
                                                    <span class="char-count" id="title-char-count">0/20</span>
                                                </div>
                                                <div class="input-field">
                                                    <label for="description">Περιγραφή (max 100 characters):</label>
                                                    <textarea name="message" id="description" maxlength="100" required
                                                        style="height: 150px;"><?php echo $message; ?></textarea>
                                            ...
                                            <button type="submit"
                                                class="btn bg-gradient-dark ms-auto mb-3 marginRight js-btn-next"
                                                id="send-btn">Αποθηκευση</button>
                                    </form>
                                    <script>
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        ...
                        <button type="button" class="close" id="cancel1" data-dismiss="modal" aria-label="Close">
